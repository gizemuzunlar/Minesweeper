...
namespace Minesweeper
{
    public partial class Form1 : Form
    {
        ...
        Image mayin_Resmi = Image.FromFile(@"bomb.png");
        ...
        public void Button_ekle(Point location)
        {
            Button btn = new Button();
            btn.Name =location.X + "" + location.Y;
       ...
       public  void btn_Click(object sender, EventArgs e)
        {
            ...
            Mayin myn = mayin_tarlamiz.Mayin_al_location(btn.Location);
        ...
        public int etrafta_kac_mayin_var(Mayin m)
        {
            ...
            if (m.konum_al.X > 0)
            {
                if (mayin_tarlamiz.Mayin_al_location(new Point(m.konum_al.X - 20, m.konum_al.Y)).mayin_var_mi)
                {
                    sayi++;
                }
            }
            ...
            {
                if (mayin_tarlamiz.Mayin_al_location(new Point(m.konum_al.X - 20, m.konum_al.Y - 20)).mayin_var_mi)
                {
                    sayi++;
                }
            }
            ...
            if (m.konum_al.Y > 0)
            {
                if (mayin_tarlamiz.Mayin_al_location(new Point(m.konum_al.X, m.konum_al.Y - 20)).mayin_var_mi)
                {
                    sayi++;
                }
            }
        ...
        public void cevresindekileri_ekle(Mayin m)
        {
            ...
            if (m.konum_al.X > 0)
            {
                mayinlarimiz.Add(mayin_tarlamiz.Mayin_al_location(new Point(m.konum_al.X - 20, m.konum_al.Y)));
                b1 = true;
            }

            if (m.konum_al.Y > 0)
            {
                mayinlarimiz.Add(mayin_tarlamiz.Mayin_al_location(new Point(m.konum_al.X , m.konum_al.Y-20)));
                b2 = true;
            }
            ...
            if(b1 && b2)
            {
                mayinlarimiz.Add(mayin_tarlamiz.Mayin_al_location(new Point(m.konum_al.X -20, m.konum_al.Y -20)));
            }
